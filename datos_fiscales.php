...
if (!isset($_SESSION["usuario"]) || $_SESSION["rol"] !== "admin") {
    echo "<p style='font-family:Arial;color:red;padding:20px;'>⛔ Acceso denegado. Esta sección es exclusiva para administradores.</p>";
    exit();
}
$cliente_id = $_GET['id'] ?? '';
?>
...
<div class="container">
    ...
    <form action="ficha_inscripcion/guardarf.php" method="POST">
    ...
    <a href="ficha_inscripcion/listarf.php" class="button-link">Ver Registros</a>
    <br><br>
